 ...
 * @author LeuoO
 */
@WebServlet(name = "ResultadoSimplesServlet", urlPatterns = {"/resultado-simples.html"})
public class ResultadoSimplesServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<title>Servlet ResultadoSimples</title>");
            out.println("</head>");
            out.println("<body>");
            ...
            out.println("<center>");
            out.println("<br></br>");
            out.println("<h2>Resultado do Juros Simples: " + capital * taxa * tempo / 100 + "</h2>");
            out.println("<center>");
            out.println("<br></br>");
