...
public class JurosCompostoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<form method='post' action='resultado-composto.html'>");
            out.println("<center>");
            out.println("<br></br>");
            out.println("<fieldset>");
            out.println("<p><h3>Capital Inicial:<h3><input type='number' name='capital'> </p>");
            out.println("<p><h3>Taxa:<h3> <input type='number' name='taxa'> </p>");
            out.println("<p><h3>Tempo:<h3> <input type='number' name='tempo'> </p>");
            out.println("<button><h4>Calcular</h4></button>");
            out.println("</fieldset>");
            out.println("</form>");
            out.println("</center>");
            out.println("</body>");
