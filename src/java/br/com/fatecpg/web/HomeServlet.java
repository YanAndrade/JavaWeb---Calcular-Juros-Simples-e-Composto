...
public class HomeServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<title>TP01 - Calcular Juros</title>");            
            out.println("</head>");
            ...
            out.println("<center>");
            out.println("<h2>A seguinte aplicação consiste em calcular juros simples e composto</h2>");
            out.println("</center>");
            out.println("<br></br>");
            out.println("<div class='row'>");
            out.println("<div class='col'>");
            out.println("<button type='button' class='btn btn-outline-primary'>");
            out.println("<h3><a href='juros-simples.html'>Juros Simples</a></h3>");
            out.println("</button>");
            out.println("</div>");
            out.println("<br></br>");
            out.println("<div cass='row'>");
            out.println("<div class='col'>");
            out.println("<button type='button' class='btn btn-outline-primary'>");
            out.println("<h3><a href='juros-composto.html'>Juros Composto</a></h3>");
            out.println("</button>");
            out.println("</div>");
            out.println("</center");
            out.println("</div>");
